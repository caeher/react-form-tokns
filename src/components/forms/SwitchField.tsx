  ...
  const content = (
    <label
      ...
      className={`flex items-center justify-between gap-3 w-full ${
        inline
          ? ''
          : `rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900/50 p-3 transition-colors ${
              disabled ? '' : 'hover:border-slate-300 dark:hover:border-slate-700 hover:bg-slate-200/50 dark:hover:bg-slate-800/50'
            }`
      ...
      <div className="relative flex items-center shrink-0">
        ...
        <div className={`h-6 w-11 rounded-full transition-all peer-focus-visible:ring-2 peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-white dark:peer-focus-visible:ring-offset-slate-950 ${
          ...
          error
            ...
            : 'bg-slate-300 dark:bg-slate-800 peer-checked:bg-cyan-500 border border-slate-400 dark:border-slate-700 peer-checked:border-cyan-400 peer-focus-visible:ring-cyan-500/50'
        }`}></div>
